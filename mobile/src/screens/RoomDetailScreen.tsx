...
const s = StyleSheet.create({
  ...
  photo: { height: vs(359) },
  photoDots: { position: "absolute", bottom: vs(16), alignSelf: "center", flexDirection: "row", gap: sc(3) },
  ...
  sheet: { flex: 1, backgroundColor: "#FFFFFF", borderTopLeftRadius: sc(32), borderTopRightRadius: sc(32), marginTop: -vs(32), paddingTop: 10 },
  handle: { width: sc(61), height: vs(8), borderRadius: 100, backgroundColor: "#D7D7D7", marginBottom: 10, alignSelf: "center" },
  sheetContent: { paddingHorizontal: sc(20), paddingBottom: vs(16), gap: vs(30) },
  section: { gap: vs(8), width: "100%" },
  sectionTitle: { fontFamily: "Outfit_600SemiBold", fontSize: ms(15), lineHeight: 25, letterSpacing: 0.3, color: "#000000" },
  roomName: { fontFamily: "Outfit_600SemiBold", fontSize: ms(15), lineHeight: 17, letterSpacing: 0.3, color: "#000000" },
  infoRow: { flexDirection: "row", alignItems: "center", gap: sc(6) },
  infoText: { fontFamily: "Outfit_400Regular", fontSize: ms(13), lineHeight: 17, letterSpacing: 0.26, color: "#000000" },
  body: { fontFamily: "Outfit_400Regular", fontSize: ms(13), lineHeight: 16, color: "#434343" },
  detailsRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  detailItem: { flexDirection: "row", alignItems: "center", gap: sc(10) },
  detailLabel: { fontFamily: "Outfit_300Light", fontSize: ms(15), lineHeight: 19, color: "#383838" },
  detailVal: { fontFamily: "Outfit_400Regular", fontSize: ms(15), lineHeight: 19, color: "#000000" },
  equipRow: { flexDirection: "row", gap: sc(10) },
  equipCol: { flex: 1, gap: vs(4) },
  equipItem: { flexDirection: "row", alignItems: "center", gap: sc(8), height: vs(25) },
  equipText: { fontFamily: "Outfit_400Regular", fontSize: ms(13), lineHeight: 25, letterSpacing: 0.26, color: "#464646" },
  bottomBar: { position: "absolute", bottom: 0, left: 0, right: 0, backgroundColor: "#FFFFFF", flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: sc(20), paddingTop: vs(12), paddingBottom: vs(28), borderTopWidth: 1, borderTopColor: "#F0F0F0" },
  barPrice: { fontFamily: "Outfit_700Bold", fontSize: ms(15), lineHeight: 17, color: "#000000" },
  reserveBtn: { backgroundColor: "#01BDA5", borderRadius: 50, paddingHorizontal: sc(28), height: vs(40), alignItems: "center", justifyContent: "center" },
  reserveBtnText: { fontFamily: "Outfit_400Regular", fontSize: ms(15), lineHeight: 15, color: "#FFFFFF", letterSpacing: 0.3 },
});
