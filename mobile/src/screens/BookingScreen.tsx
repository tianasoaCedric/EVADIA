...
const s = StyleSheet.create({
  ...
  photo: { height: vs(359) },
  photoHeader: { position: "absolute", top: vs(61), left: sc(20) },
  iconBtn: { width: sc(42), height: sc(42), borderRadius: sc(38), alignItems: "center", justifyContent: "center" },
  sheet: { flex: 1, backgroundColor: "#FFFFFF", borderTopLeftRadius: sc(32), borderTopRightRadius: sc(32), marginTop: -vs(99), paddingTop: 10 },
  handle: { width: sc(61), height: vs(8), borderRadius: 100, backgroundColor: "#D7D7D7", marginBottom: 10, alignSelf: "center" },
  sheetContent: { paddingHorizontal: sc(20), paddingBottom: vs(60) },
  priceRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingVertical: vs(15) },
  priceText: { fontFamily: "Outfit_500Medium", fontSize: ms(24), lineHeight: 30, color: "#000000" },
  nightsBadge: { backgroundColor: "#01BDA5", borderRadius: sc(50), paddingHorizontal: sc(12), paddingVertical: vs(8) },
  nightsText: { fontFamily: "Outfit_400Regular", fontSize: ms(13), color: "#FFFFFF" },
  divider: { height: 1, backgroundColor: "#5A5A5A" },
  section: { paddingVertical: vs(15), gap: vs(12) },
  bookingRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  bookingLabel: { fontFamily: "Outfit_300Light", fontSize: ms(13), color: "#4E4E4E" },
  datePill: { flexDirection: "row", alignItems: "center", gap: sc(8), backgroundColor: "#F5F5F5", borderRadius: 50, paddingHorizontal: sc(14), height: vs(38) },
  dateText: { fontFamily: "Outfit_400Regular", fontSize: ms(13), color: "#000000" },
  counter: { flexDirection: "row", alignItems: "center", gap: sc(16) },
  counterBtn: { width: sc(30), height: sc(30), borderRadius: sc(15), backgroundColor: "#F5F5F5", alignItems: "center", justifyContent: "center" },
  counterVal: { fontFamily: "Outfit_500Medium", fontSize: ms(16), color: "#000000", minWidth: 20, textAlign: "center" },
  summaryRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  summaryLabel: { fontFamily: "Outfit_300Light", fontSize: ms(13), color: "#4E4E4E" },
  summaryBold: { fontFamily: "Outfit_700Bold", fontSize: ms(13) },
  summaryValue: { fontFamily: "Outfit_500Medium", fontSize: ms(15), color: "#4E4E4E" },
  summaryValueBold: { fontFamily: "Outfit_700Bold", fontSize: ms(24), lineHeight: 30 },
  totalSection: { paddingVertical: vs(8) },
  reserveBtn: { backgroundColor: "#01BDA5", borderRadius: sc(25), height: vs(40), alignItems: "center", justifyContent: "center", marginTop: vs(20) },
  reserveBtnText: { fontFamily: "Outfit_600SemiBold", fontSize: ms(14), letterSpacing: 0.28, color: "#FFFFFF" },
});

const cal = StyleSheet.create({
  overlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.5)", justifyContent: "flex-end" },
  sheet: { backgroundColor: "#FFFFFF", borderTopLeftRadius: sc(24), borderTopRightRadius: sc(24), paddingHorizontal: sc(20), paddingBottom: vs(36), paddingTop: vs(16) },
  header: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: vs(16) },
  navBtn: { width: sc(36), height: sc(36), alignItems: "center", justifyContent: "center" },
  monthTitle: { fontFamily: "Outfit_600SemiBold", fontSize: ms(16), color: "#000000" },
  weekRow: { flexDirection: "row", marginBottom: vs(8) },
  weekDay: { flex: 1, textAlign: "center", fontFamily: "Outfit_400Regular", fontSize: ms(12), color: "#9CA3AF" },
  grid: { flexDirection: "row", flexWrap: "wrap", width: "100%", rowGap: vs(6) },
  cell: { width: `${100 / 7}%`, height: vs(44), alignItems: "center", justifyContent: "center" },
  cellInRange: { backgroundColor: "#E6F9F7" },
  cellSelected: { backgroundColor: "#01BDA5", borderRadius: 100, width: sc(34), height: sc(34) },
  innerCircle: { width: sc(34), height: sc(34), alignItems: "center", justifyContent: "center" },
  innerCircleSelected: { backgroundColor: "#01BDA5", borderRadius: 100 },
  cellDisabled: { opacity: 0.35 },
  cellText: { fontFamily: "Outfit_400Regular", fontSize: ms(14), color: "#000000" },
  cellTextSelected: { color: "#FFFFFF", fontFamily: "Outfit_600SemiBold" },
  cellTextDisabled: { color: "#9CA3AF" },
  dot: { position: "absolute", bottom: vs(4), width: sc(4), height: sc(4), borderRadius: sc(2), backgroundColor: "#EF4444" },
  legend: { flexDirection: "row", gap: sc(20), justifyContent: "center", marginTop: vs(12) },
  legendItem: { flexDirection: "row", alignItems: "center", gap: sc(6) },
  legendDot: { width: sc(10), height: sc(10), borderRadius: 5 },
  legendText: { fontFamily: "Outfit_400Regular", fontSize: ms(12), color: "#6B7280" },
  closeBtn: { marginTop: vs(16), alignSelf: "center", paddingHorizontal: sc(32), paddingVertical: vs(10), backgroundColor: "#F5F5F5", borderRadius: sc(20) },
  closeTxt: { fontFamily: "Outfit_500Medium", fontSize: ms(14), color: "#000000" },
});
