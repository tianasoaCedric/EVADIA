    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $hotels = Hotel::with([
            ...
            ->map(function (Hotel $h) {
                $proprietes = $h->proprietes()->whereHas('currentPrix')->with('currentPrix')->get();
                return [
                    'id'               => $h->id,
                    'nom'              => $h->nom,
        ...
        return response()->json(compact('hotels', 'destinations', 'villes', 'types', 'decouverte_villes', 'decouverte_lieux'));
    }
}
