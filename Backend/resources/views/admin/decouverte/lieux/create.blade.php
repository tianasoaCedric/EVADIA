        ...
        <form method="POST" action="{{ route('admin.decouverte.villes.lieux.store', $ville) }}" enctype="multipart/form-data"
            ...
            <div class="rounded-2xl bg-white shadow-sm ring-1 ring-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">
                            Photos <span class="text-xs text-gray-400 font-normal">(plusieurs possibles — s'affichent en carrousel)</span>
                        </label>
                        ...
                        @error('images.*') <p class="mt-1.5 text-xs text-red-500">{{ $message }}</p> @enderror
                    </div>
