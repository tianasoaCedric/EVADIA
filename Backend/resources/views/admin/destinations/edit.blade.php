...
@section('title', 'Modifier destination - EVADIA Admin')
@section('page_title', 'Modifier : ' . $destination->nom)
            ...
            <div class="rounded-2xl bg-white shadow-sm ring-1 ring-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="nom" value="{{ old('nom', $destination->nom) }}" required
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4"
                            class="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-900 shadow-sm transition-colors focus:border-evadia-500 focus:ring-2 focus:ring-evadia-500/20 focus:outline-none">{{ old('description', $destination->description) }}</textarea>
                        @error('description')<p class="mt-1.5 text-xs text-red-500">{{ $message }}</p>@enderror
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">Photo de couverture</label>
