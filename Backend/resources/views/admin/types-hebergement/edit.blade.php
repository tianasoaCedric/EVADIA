            ...
            <div class="rounded-2xl bg-white shadow-sm ring-1 ring-gray-100 p-6 space-y-5">
                ...
                <div>
                    ...
                    <textarea name="description" rows="4"
                        class="w-full rounded-xl border-gray-300 px-4 py-2.5 text-sm focus:border-evadia-500 focus:ring-2 focus:ring-evadia-500/20">{{ old('description', $type->description) }}</textarea>
                </div>
